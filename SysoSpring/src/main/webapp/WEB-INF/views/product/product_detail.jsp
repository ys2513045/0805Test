		...
		<div id="wrap">
			<c:forEach items="${list}" var="list">
				...
				<article class="product_detail">
					...
					<c:choose>
						<c:when test="${(empty sessionScope) || (sessionScope.id ne list.member_id)}">
							...
							<div class="btn_area">
								...
								<button class="btn2" id="contact"
									onclick="openTalk(${list.item_idx})">연락하기</button>
			...
			<div class="right_area">
				...
				<div class="shop_area">
					<div class="shop_name">
						...
						<div class="shop_text">
							<a href="https://m.bunjang.co.kr/shop/11371999/products">상품${sList.shop_itemCount }</a>
						</div>

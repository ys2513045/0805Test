...
+----------------+--------------+------+-----+---------+----------------+
| report_idx     | int(11)      | NO   | PRI | NULL    | auto_increment |
| member_id      | varchar(45)  | NO   | MUL | NULL    |                |
| report_content | varchar(200) | YES  |     | NULL    |                |
| shopReview_idx | int(11)      | YES  | MUL | NULL    |                |
| comment_idx    | int(11)      | YES  | MUL | NULL    |                |
| item_idx       | int(11)      | YES  | MUL | NULL    |                |
| shop_member_id | varchar(45)  | YES  | MUL | NULL    |                |
| report_state   | int(11)      | YES  |     | NULL    |                |
| report_date    | timestamp    | YES  |     | NULL    |                |
+----------------+--------------+------+-----+---------+----------------+
	 */
